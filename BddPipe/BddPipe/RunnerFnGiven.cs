...
namespace BddPipe
{
    public static partial class Runner
    {
        ...
        public static Either<Ctn<Exception>, Ctn<Unit>> Given(string title, Action step) =>
            Pipe(new Either<Ctn<Exception>, Ctn<Unit>>(new Ctn<Unit>(new Unit(), None)), title.ToTitle(StepGiven), step.PipeFunc<Unit>());
        ...
        public static Either<Ctn<Exception>, Ctn<R>> Given<R>(string title, Func<Task<R>> step) =>
            Pipe(new Either<Ctn<Exception>, Ctn<Unit>>(new Ctn<Unit>(new Unit(), None)), title.ToTitle(StepGiven), step.PipeFunc<Unit, R>());
        ...
        public static Either<Ctn<Exception>, Ctn<Unit>> Given(this Scenario scenario, string title, Action step) =>
            Pipe(new Either<Ctn<Exception>, Ctn<Unit>>(new Ctn<Unit>(new Unit(), scenario.Title)), title.ToTitle(StepGiven), step.PipeFunc<Unit>());
        
        /// <summary>
        /// Specify the Given step implementation following the Scenario
        /// </summary>
        public static Either<Ctn<Exception>, Ctn<R>> Given<R>(this Scenario scenario, string title, Func<Task<R>> step) =>
            Pipe(new Either<Ctn<Exception>, Ctn<Unit>>(new Ctn<Unit>(new Unit(), scenario.Title)), title.ToTitle(StepGiven), step.PipeFunc<Unit, R>());
